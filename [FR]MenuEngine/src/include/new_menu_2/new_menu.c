...
void do_nothing();
void exit();
const u8*  new_menu_2_get_bg_pal();
const u16* new_menu_2_get_bg_map();
const u8*  new_menu_2_get_bg_tiles();

const struct InterfaceDefinition NEW_MENU_2_DEFINITION = {
    .gui_bg_config =new_menu_bg_config, 
    .gui_text_pal  =test_text_pal,
    .get_bg_map        =new_menu_2_get_bg_map, 
    .get_bg_tilesets   =new_menu_2_get_bg_tiles,
    .get_bg_pal        =new_menu_2_get_bg_pal, 
...
const u16* new_menu_2_get_bg_map(){
    return new_menu_2_guiMap;
}
const u8* new_menu_2_get_bg_tiles(){
    return new_menu_2_guiTiles;
}
const u8* new_menu_2_get_bg_pal(){
    return new_menu_2_guiPal;
}
